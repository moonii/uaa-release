...
*/
    private final String OPTIONAL_BCRYPT_PREFIX = "sha256";
    private final PasswordEncoder defaultPasswordEncoder;
    public BackwardsCompatibleDelegatingPasswordEncoder(final StandardPasswordEncoder defaultPasswordEncoder) {
        this.defaultPasswordEncoder = defaultPasswordEncoder;
    }
